...
- **Menu konteks Pages**: Klik kanan folder page membuka aksi Publish, Unpublish, dan Delete. Publish/Unpublish mengubah marker publikasi page. Delete menghapus seluruh workspace page setelah konfirmasi di dialog aplikasi. Kegagalan load/aksi menampilkan hint error dengan `code · message` dari API bila tersedia.
