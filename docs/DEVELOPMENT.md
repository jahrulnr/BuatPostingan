# Development — BuatPostingan

Local setup, repo layout, and environment variables for contributors and coding agents.

Product overview: [README](../README.md) · Docs index: [docs/README.md](README.md) · Agent rules: [AGENTS.md](../AGENTS.md)
...
| [`docs/`](README.md) | Docs index (architecture, turn loop, LLM, runbook) |
| [`docs/architecture/`](architecture/README.md) | CA map + tools / persistence / FE |
| [`docs/architecture/portable-ai-kit.md`](architecture/portable-ai-kit.md) | What to copy for reuse in other products |
...
See [`.env.example`](../.env.example), [`docs/operations/runbook.md`](operations/runbook.md), and [`docs/architecture/llm-providers.md`](architecture/llm-providers.md).

## Make targets

| Target | Purpose |
|---|---|
| `make fe` / `make run-fe` | Static FE + livereload (`:5173`; needs Node) |
| `make be` / `make run-be` / `make run` | Go app + reflex reload (`:8080`) |
